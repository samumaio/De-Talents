...
async function main() {
    ...
    const abi = fs.readFileSync("./contracts/UserNFT.sol/UserNFT.json", "utf8"); // lettura file abi del contract
    const bin = fs.readFileSync("./contracts/UserNFT.sol/UserNFT.bin", "utf8"); // lettura file bin del contract
